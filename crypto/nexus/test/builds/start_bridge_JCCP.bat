...
set bit_35=NEXUS_JCCP_JC35_400Mhz_WNS-0.188.bit
set bridge=sqrl_bridge_2.1.4.exe
REM ### Set bridgeoptions
if [%devicetype%] EQU [fk33] set bridgeoptions=-a -t  -g -q -b %bit_33%
...
if [%devicetype%] EQU [jcc4p_35] set bridgeoptions=-a -t  -g -q -b %bit_35%
REM ### Run Bridge
